...
<footer style="background-color: #9c9c9c">
  <div class="container-fluid">
    <div class="col-sm-4 hov">
      ...
      <center><a href="#" class="btn btn-danger"><b>Voir plus..</b></a></center><br><br><br>
      <?php
        ...
        <div class="panel-body">
          <div class="feedback">
            <form method="post"><br>
              ...
              <input style="background-color: #000000" type="submit" value="Envoyer" name="send" class="btn btn-primary btn-group-justified" required>
            </form>
          </div>
        </div>
      </div>
